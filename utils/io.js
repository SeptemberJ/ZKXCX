...
function decodePacket(t) {
  var e = t.charAt(0);
  return t.length > 1 ? { type: packetslist[e], data: t.substring(1) } : { type: packetslist[e] }
}
...
function encodeAsString(t) {
  var e = "",
    n = !1;
  return e += t.type, t.nsp && "/" != t.nsp && (n = !0, e += t.nsp), null != t.id && (n && (e += ",", n = !1), e += t.id), null != t.data && (n && (e += ","), e += JSON.stringify(t.data)), e
}

function decoder(t, e) {
  var n = void 0;
  "string" == typeof t && (n = decodeString(t)), e(n)
}
...
var _debug = function (t) {
  return function () {
    ...
    if (__wxConfig.debug) {
      var i;
      (i = console.log).call.apply(i, [null, t].concat(n))
    }
  }
};
var GlobalEmitter = index$1({ hasEmitte: !1 });
var debug$2 = _debug("app:Engine:");
index$1(Engine$1.prototype);
var packets = { open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6 };
...
var parser = { CONNECT: 0, DISCONNECT: 1, EVENT: 2, ACK: 3, ERROR: 4, BINARY_EVENT: 5, BINARY_ACK: 6 };
var events = {
  connect: 1,
  connect_error: 1,
  connect_timeout: 1,
...
Socket$1.prototype.subEvents = function () {
  ...
  var e = t.data || [];
  debug$3("emitting event -> ", t), this.connected ? emit.apply(this, e) : this.receiveBuffer.push(e)
  ...
  if (events.hasOwnProperty(e[0])) return emit.apply(this, e), this;
  var o = parser.EVENT,
    i = { type: o, data: e, options: {} };
  return this.connected ? this.packet(i) : this.sendBuffer.push(i), this
...
index$1(Manager.prototype), Manager.prototype.open = Manager.prototype.connect = function (t) {
  var e = this;
  if (~this.readyState.indexOf("open")) return this;
  this.engine = new Engine$1(this.uri, this.opts), this.readyState = "opening";
  var n = this.engine;
  return this.subs.push(on(n, "open", function () {
  ...
  debug$1("on open"), this.cleanup(), this.readyState = "open", this.emit("open");
  var t = this.engine;
  this.subs.push(on(t, "data", index$2(this, "ondata"))), this.subs.push(on(t, "ping", index$2(this, "onping"))), this.subs.push(on(t, "pong", index$2(this, "onpong"))), this.subs.push(on(t, "error", index$2(this, "onerror"))), this.subs.push(on(t, "close", index$2(this, "onclose")))
  ...
  var e = this;
  debug$1("on data -> ", t), this.decoder(t, function (t) {
  ...
  var e = this.nsps[t];
  return e || (e = new Socket$1(this, t), this.nsps[t] = e), e
  ...
  var t = this;
  return debug$1("reconnect: reconnecting -> ", this.reconnecting, "skipReconnect -> ", this.skipReconnect), this.reconnecting || this.skipReconnect ? this : void (this.backoff.attempts >= this._reconnectionAttempts ? (debug$1("reconnect failed"), this.backoff.reset(), this.emitAll("reconnect_failed"), this.reconnecting = !1) : !function () {
    var e = t.backoff.duration();
    debug$1("will wait %dms before reconnect attempt", e), t.reconnecting = !0;
  ...
  var e = index$4(this.connecting, t);
...
var url = function (t) {
  var e = index$5(t);
  e.port || (/^(http|ws|https|wss)$/.test(e.protocol) ? e.port = "80" : /^(http|ws|https|wss)s$/.test(e.protocol) && (e.port = "443")), e.path = e.path || "/";
  var n = e.host.indexOf(":") !== -1;
  var o = n ? "[" + e.host + "]" : e.host;
  return e.id = e.protocol + "://" + o + ":" + e.port, e
};
...
function lookup(t, e) {
  ...
  var i = n.id;
  var r = n.path;
  var s = cache[i] && r in cache[i].nsps;
  var c = e.forceNew || e["force new connection"] || !1 === e.multiplex || s;
  debug("cache: ", cache);
  var a = void 0;
  return c ? (debug("newConnection is true"), a = Manager(o, e)) : (debug("newConnection is false"), cache[i] || (debug("----------> no cache"), cache[i] = Manager(o, e)), debug("==========> has cache"), a = cache[i]), debug("ready to call io.socket path is -> ", n.path), a.socket(n.path)
}
